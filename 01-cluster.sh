...
aws cloudformation deploy --template-file cluster.yaml --stack-name "a-new-startup-ecs-cluster" --parameter-overrides VpcId=$VPC_ID PublicSubnets=$1 PrivateSubnets=$2 --capabilities CAPABILITY_NAMED_IAM